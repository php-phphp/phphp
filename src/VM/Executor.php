...
class Executor
{
    ...
    public function execute(OpArray $opArray, array &$symbolTable = [], FunctionDataInterface $function = null, array $args = [], Zval $result = null, Objects\ClassInstance $ci = null)
    {
    ...
    public function getCallback($callback)
    {
        ...
        if (is_string($callback)) {
            ...
            return function (Executor $executor, array $args = [], Zval $return = null) use ($cb) {
            ...
            if ($class instanceof Objects\ClassInstance) {
                return function (Executor $executor, array $args = [], Zval $return = null) use ($class, $method) {
        ...
        } elseif ($callback instanceof FunctionDataInterface) {
            return function (Executor $executor, array $args = [], Zval $return = null) use ($callback) {
        ...
        if (!$this->extensions->contains($extension)) {
            ...
            if (method_exists($extension, 'preExecute')) {
                if ($this->preExecute) {
                    ...
                    $this->preExecute = [$extension, 'preExecute'];
                }
            }
            if (method_exists($extension, 'postExecute')) {
                if ($this->postExecute) {
                    ...
                    $this->postExecute = [$extension, 'postExecute'];
                }
            }
        }
    }
